...
# 
#
# usage: python find_pdb_file_and_symlink.py your_ACC_list_file
#        python find_pdb_file_and_symlink.py uni_acc_str_2.txt
#        python find_pdb_file_and_symlink.py uni_acc_str_of_validation_set.txt
...
for acc in ACCs_list:
    ...
    for pdb_id in pdb_id_list:
        ...
        pdb_file_path = input_path + '/pdb/' + pdb_dir_name
