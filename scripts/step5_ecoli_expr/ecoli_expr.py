...
def is_expr_sys_ecoli(header_dict):
    '''
    checks if expression system is e.coli
    :param header_dict: header of pdb file in dictionary format
    :return: True or False
    '''
    if get_expr_sys_info(header_dict) == 'escherichia coli':
        return True
    else:
        return False
...
print "Is expression system E.coli? "
print is_expr_sys_ecoli(pdb_header_dict)